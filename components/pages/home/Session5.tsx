...
const HomeSession5 = () => {
  ...
  return (
    <section className=" relative bg-skin-navy-blue pt-16 pb-4">
      <div className=" relative overflow-hidden  container grid lg:grid-cols-2 gap-10 lg:items-center">
      ...
      <svg
        ...
        viewBox="0 0 56 54"
        fill="none"
        className=" absolute top-10 hidden sm:block  left-[10%]"
      >
        <path
