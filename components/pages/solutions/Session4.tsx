      ...
      <div className="  relative container">
        ...
        <div className=" grid lg:grid-cols-2 gap-5 pt-8 lg:items-center">
          <div className=" space-y-4 lg:space-y-7">
            ...
            <p>
              An exclusive area to your mentee where they will be able to easily
              access the broadcast link for your schedule sessions,
              supplementary material such as videos, PDFs, tasks and much more.
            </p>
...
export default SolutionsSession4;
